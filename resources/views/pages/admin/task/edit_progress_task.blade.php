        ...
        <div class="card-body">
            <form action="{{ route('task.detail.update', $progress->id_progress_task) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="form-control" required disabled>{{ old('deskripsi', $progress->deskripsi) }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="image[]" id="image" class="form-control" accept=".jpg, .jpeg, .png, .pdf" multiple disabled>
                    <small class="form-text text-muted">Supported formats: JPG, PNG, PDF. You can upload multiple files.</small>
                </div>

                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">Update Progress</button>
                    <a href="{{ route('task.detail', $progress->task->id_task) }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
