            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <form action="{{ route('task.detail.update', $progress->id_progress_task) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label for="comment" class="form-label" style="color: #0B20E9; font-weight: bold;">Komentar</label>
                            <textarea class="form-control" id="comment" name="comment" rows="3" placeholder="Masukkan komentar...">{{ old('comment', $progress->comment) }}</textarea>
                        </div>
                        <div class="mb-3">
